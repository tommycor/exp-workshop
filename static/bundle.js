(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"D:\\Documents\\git\\exp-workshop\\node_modules\\victor\\index.js":[function(require,module,exports){
...
},{}],"D:\\Documents\\git\\exp-workshop\\src\\scripts\\components\\collider.js":[function(require,module,exports){
'use strict';
			...
			for (var i = 0; i < particles.length - 1; i++) {
				...
				for (var j = i + 1; j < particles.length; j++) {
					...
					if (particle.isSelected || force < 3) {
						...
						particle.collision.add(director.clone().multiply(new _victor2['default'](force, force)));
						other.collision.add(director.multiply(new _victor2['default'](-force, -force)));
					}
				}
			}
		}
...
},{"../utils/config":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\config.js","victor":"D:\\Documents\\git\\exp-workshop\\node_modules\\victor\\index.js"}],"D:\\Documents\\git\\exp-workshop\\src\\scripts\\components\\gravity.js":[function(require,module,exports){
'use strict';
...
module.exports = (function () {
	...
	_createClass(Gravity, [{
		...
		value: function update(particle) {
			...
			var diff = 0;
			var dist = 0;
			var force = _utilsConfig2['default'].gravityForce;
...
},{"../utils/config":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\config.js","victor":"D:\\Documents\\git\\exp-workshop\\node_modules\\victor\\index.js"}],"D:\\Documents\\git\\exp-workshop\\src\\scripts\\components\\particle.js":[function(require,module,exports){
'use strict';
...
var _utilsTransformer = require('../utils/transformer');

var _utilsTransformer2 = _interopRequireDefault(_utilsTransformer);
...
module.exports = (function () {
	function Particle(options) {
		...
		this.position = options.position !== void 0 ? options.position : new _victor2['default'](0, 0);
		...
		this.gravity = new _victor2['default'](0, 0);
		this.collision = new _victor2['default'](0, 0);
		this.force = new _victor2['default'](0, 0);

		this.scale = new _victor2['default'](this.radius * .02, this.radius * .02);
	...
	_createClass(Particle, [{
		...
		value: function update() {
			this.force = (0, _victor2['default'])(0, 0);
			...
			(0, _utilsTransformer2['default'])(this.el, 'translate3d(' + (this.position.x - this.radius) + 'px, ' + (this.position.y - this.halfRadius) + 'px, 0) scale(' + this.scale.x + ', ' + this.scale.y + ')');
		}
	}, {
		key: 'resetForces',
		value: function resetForces() {
			this.gravity = new _victor2['default'](0, 0);
			this.collision = new _victor2['default'](0, 0);
		}
	}, {
...
},{"../utils/raf":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\raf.js","../utils/transformer":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\transformer.js","victor":"D:\\Documents\\git\\exp-workshop\\node_modules\\victor\\index.js"}],"D:\\Documents\\git\\exp-workshop\\src\\scripts\\components\\scene.js":[function(require,module,exports){
'use strict';
...
module.exports = {
	...
	init: function init() {
		...
		for (var i = 0; i < _utilsConfig2['default'].nbrParticles; i++) {
			this.particles.push(new _particle2['default']({
				...
				position: new _victor2['default'](Math.random() * this.winWidth - this.halfWidth, Math.random() * this.winHeight - this.halfHeight),
		...
		this.gravity = new _gravity2['default']();
		this.collider = new _collider2['default']();
	...
	onSelected: function onSelected(particle) {
...
},{"../utils/config":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\config.js","../utils/mapper":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\mapper.js","../utils/raf":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\raf.js","./collider":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\components\\collider.js","./gravity":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\components\\gravity.js","./particle":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\components\\particle.js","victor":"D:\\Documents\\git\\exp-workshop\\node_modules\\victor\\index.js"}],"D:\\Documents\\git\\exp-workshop\\src\\scripts\\initialize.js":[function(require,module,exports){
'use strict';
...
},{"./components/scene":"D:\\Documents\\git\\exp-workshop\\src\\scripts\\components\\scene.js"}],"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\config.js":[function(require,module,exports){
'use strict';
...
},{}],"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\mapper.js":[function(require,module,exports){
...
},{}],"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\raf.js":[function(require,module,exports){
'use strict';
...
},{}],"D:\\Documents\\git\\exp-workshop\\src\\scripts\\utils\\transformer.js":[function(require,module,exports){
"use strict";
...
},{}]},{},["D:\\Documents\\git\\exp-workshop\\src\\scripts\\initialize.js"])
